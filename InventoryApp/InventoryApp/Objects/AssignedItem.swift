...
public class AssignedItem{
    ...
    public init(name:String, asuriteId:String, email:String, phoneNumber:String, reason:String, adaptorName:String){
        self.name = name
    ...
    public func toString() -> String{
        return "Name: \(name)/nAsurite ID: \(asuriteId)/nE-Mail: \(email)/nPhone #: \(phoneNumber)/nReason: \(reason)/nLoaned Date: \(loanedDate)/nAdaptor Borrowed\(adaptorName)"
    }
}
